...
var _ValidationError = _interopRequireDefault(require("schema-utils/dist/ValidationError"));
var _memorize = _interopRequireDefault(require("schema-utils/dist/util/memorize"));
...
const getAjv = (0, _memorize.default)(() => {
  ...
  // Custom keywords
  // eslint-disable-next-line global-require
  const addAbsolutePathKeyword = require("schema-utils/dist/keywords/absolutePath").default;
  addAbsolutePathKeyword(ajv);

  // eslint-disable-next-line global-require
  const addLimitKeyword = require("schema-utils/dist/keywords/limit").default;
  addLimitKeyword(ajv);
  const addUndefinedAsNullKeyword =
  // eslint-disable-next-line global-require
  require("schema-utils/dist/keywords/undefinedAsNull").default;
